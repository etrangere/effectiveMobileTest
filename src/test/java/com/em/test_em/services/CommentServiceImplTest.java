...
public class CommentServiceImplTest {
  ...
  @Mock private CommentServiceImpl commentServiceImplMock;
  ...
  public void testGetCommentByTask() {
    ...
    // repository method and objective of test
    when(commentServiceImplMock.getCommentByTask(taskId))
  ...
  public void testGetCommentByIdAndTaskId() {
    ...
    // repository method and objective of test
    when(commentServiceImplMock.getCommentByIdAndTaskId(taskId, commentId))
  ...
  public void testUpdateCommentForTask() {
    ...
    // what to be checked or verified
    CommentDTO result =
        commentServiceImplMock.updateCommentForTask(taskId, commentId, updatedCommentDTO);
